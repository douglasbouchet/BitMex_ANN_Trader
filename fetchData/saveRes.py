...
def savePred(delay, state, proba, timeframe):
    ...
    switcher2 = {
        ...
        "1_h": datetime.datetime(cur.year, cur.month, cur.day, cur.hour, 0, 0),
        "2_h": datetime.datetime(cur.year, cur.month, cur.day, cur.hour // 2 * 2, 0, 0),
        "4_h": datetime.datetime(cur.year, cur.month, cur.day, cur.hour // 4 * 4, 0, 0),
    }
